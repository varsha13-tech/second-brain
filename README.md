...
Second Barin is a personal knowledge management app — a simple “second brain” where you can capture notes, links, and ideas, and use AI to make sense of them over time.
...
The assignment mentions Next.js as the preferred frontend framework.
This project uses Vite + React, and I want to briefly explain why.
